...
var cnItems = {
    ...
    'Also has an average watts/sec display': '并显示每秒瓦特收益',
    ...
    'Reboot in 5 Prestiges or less': '只能进行不超过5次转生',
    'Reboot in 4 Prestiges or less': '只能进行不超过4次转生',
    'Reboot in 3 Prestiges or less': '只能进行不超过3次转生',
    'Reboot in 2 Prestiges or less': '只能进行不超过2次转生',
    'Reboot in 1 Prestige or less': '只能进行不超过1次转生',
    'Multi-Prestige, Reboot Residue, Ease of Completion do not apply': '多重转生、重启余产和易于完成无效',
    'Reboot in 0 Prestiges or less': '只能进行不超过0次转生',
    'LONG': '长整型记数法',
    'STANDARD': '基本记数法',
    'SCIENTIFIC': '科学记数法',
    'ENGINEERING': '工程记数法',
    ...
    'Begin Push Time (in seconds': '推进等级开始时间(单位为秒',
    'EXIT CHALLENGE': '退出挑战',
    'mg helium': '毫克氦',
    ...
    'Deuterium Power': '氘供能',
    'QUANTIZE!': '量子化!',
    '108 challenge completions required': '需要完成108次挑战',
    ...
    'Unlocks automation for pushing levels': '解锁自动推进等级',
    'Auto-Quantize': '自动量子化',
