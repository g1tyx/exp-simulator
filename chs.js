...
var cnItems = {
    ...
    "Achievement requirement here": "成就要求在这里",
    "Autoclicking:": "自动点击:",
    "Automation:": "自动化:",
    "CANCEL": "取消",
    "Challenge": "挑战",
    "SKIP OFFLINE PROGRESS": "跳过离线进度",
    "SKIP HALF OF TICKS": "跳过一半的Tick",
    "Resets dark matter and": "重置暗物质和",
    "Offline Speed": "离线速度",
    "Offline Progress": "离线进度",
    "Highest Level:": "最高等级:",
    "Highest Level (Current Iteration):": "最高等级（本次迭代）：",
    "Highest Level (All Time):": "最高等级（全部时间）：",
    "High Voltage": "高电压",
    "Hide Completed Challenges": "隐藏已完成挑战",
    "IMPORT": "导入",
    "Past Quantum Iterations:": "之前的量子迭代：",
    "Past Prestiges:": "之前声望:",
    "Level-Up Rate:": "升级速率:",
    "Paste your exported save code here:\n ": "将之前导出的存档代码粘贴到这里：\n",
    "Current Hydrogen:": "当前氢:",
    "Current Photons:": "当前光子:",
    "Current Prestige Points:": "当前声望点数:",
    "Extra Cycles": "额外的周期",
    "Fastest Prestige:": "最快声望:",
    "EXP Flux permanently increases 5x faster and has a 5x higher cap": "经验通量永久提高5倍，并且上限提高5倍",
    "Capacitance Mode:": "电容模式:",
    "Auto-Reboot Watts:": "自动重启瓦特：",
    "Discharge at (seconds):": "放电时间（秒）：",
    "Fully Automatic": "全自动",
    "Generator Power:": "发动机力量:",
    "OK": "确定",
    "Priority Mode:": "优先模式:",
    "Speed Power": "速度力量",
    "Starter Kit": "入门套件",
    "Total EXP (All Time):": "总经验 (所有时间):",
    "Total Clicks (All Time):": "总点击 (所有时间):",
    "Total Clicks (Current Iteration):": "总点击 (本次迭代):",
    "Total EXP (Current Iteration):": "总经验 (本次迭代):",
    "Total Clicks (Current Prestige):": "总点击 (本次声望):",
    "Total EXP (Current Prestige):": "总经验 (本次声望):",
    "Total Clicks (Current Reboot):": "总点击 (本次重启):",
    "Total EXP (Current Reboot):": "总经验 (本次重启):",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "   ": "",
    "  ": "",
    "EXP Simulator v": "经验模拟器 v",
    "Achievements earned: ": "达成的成就: ",
    "All EXP production ": "全部经验生产 ",
...
var cnPostfix = {
    ...
    ' XV': ' XV',
    ' XVI': ' XVI',
    "A game about leveling up": "一款关于升级的游戏",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Currently running about (.+) ticks\/sec$/, '当前运行 $1 tick/秒'],
    [/^You have (.+) points$/, '你有 $1 点数'],
    [/^EXP Battery is now (.+) stronger$/, '经验电池现在增强 $1'],
    ...
    [/^\+(.+) photons$/, '\+$1 光子'],
    [/^\+(.+) g hydrogen$/, '\+$1 g 氢'],
    [/^Base EXP Production: (.+) EXP\/sec$/, '基础经验生产：$1 经验\/秒'],
    [/^Current Quantize Goal: (.+) photon$/, '当前量子化目标：$1 光子'],
    [/^Cost: (.+) points$/, '成本：$1 点数'],
    [/^Req: (.+) elves$/, '要求：$1 精灵'],
    [/^Req: (.+) \/ (.+) elves$/, '要求：$1 \/ $2 精灵'],
    [/^Usages: (\d+)\/$/, '用途：$1\/'],
