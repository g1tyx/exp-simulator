...
var cnItems = {
    ...
    'g hydrogen': '克氢',
    'Reach 98,304 watts to start gaining hydrogen!': '达到98304瓦特后才能获得氢！',
    ...
    'EXP Simulator v2.15.4': '经验模拟器 v2.15.4',
    'Made by Zakuro': '作者Zakuro，汉化者by22dgb',
    'Last updated March 26, 2025': '最近更新时间：2025年3月26日',
    //#endregion
    //#region 初始化
    'Priority': '优先级',
    ...
    'What goes up... apparently doesn\'t come down': '盛极……未必衰',
    ...
    'One must imagine Sisyphus happy': '必须设想，西西弗斯是幸福的',
    ...
    'Catching up on time since the game was last saved...': '正在同步上次存档后的时间进度……',
    'Please keep the game on-screen': '请保持游戏界面在前台',
    'Heads up! Increasing offline speed or skipping': '注意：增加离线速度或跳过',
    'ticks may make automation less efficient\n ': '时刻可能导致自动化效率降低',
    'SKIP HALF OF TICKS': '跳过一半时刻',
